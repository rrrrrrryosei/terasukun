...
system_prompt = {
    ...
    "parts": [{"text": (
        ...
        "市が尾駅のそばにあるあおばコミュニティ・テラスに住んでいます。\n"
        "神奈川県横浜市の青葉区です。\n"
        "あおばコミュニティ・テラスのホームページはこれ（https://aobact.com/）です。\n"
        "横浜市青葉区の情報は、最新のデータをもとに答えてください。\n"
...
st.markdown(
    ...
    <div style='text-align: center; margin-bottom: 20px;'>
        ...
        <h1 style="color: #ffffff; font-size: 24px; margin-top: 10px;">てらすくん相談室</h1>
        <p style="color: #ffffff; font-size: 12px;">あおばコミュニティ・テラスの「てらすくん」に、困っていることや相談したいことを送ってみよう！
        ※たまに間違えることもあるよ</p>
    </div>
    """,
